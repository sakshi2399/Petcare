    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(numRows == 0){
            ...
            while (data.moveToNext()) {                 //------make column changes here----------
                pets = new Pets(data.getString(1), data.getString(2), data.getString(3), data.getString(4), data.getString(5) , data.getBlob(6));
                petsList.add(i, pets);                //-----------make column changes here-----------
                System.out.println(data.getString(1) + " " + data.getString(2) + " " + data.getString(3) + " " + data.getString(4)+ " " + data.getString(5) + " " + data.getBlob(6));
