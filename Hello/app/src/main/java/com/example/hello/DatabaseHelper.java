...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String TABLE_NAME = "pets_data5";          ///change table name here
    ...
    private static final String COL8 = "PETPHONE";
    ...
    public void onCreate(SQLiteDatabase db) {
        String createTable = "CREATE TABLE " + TABLE_NAME + " (ID INTEGER PRIMARY KEY AUTOINCREMENT, " +
                " PETNAME TEXT, PETSPECIES TEXT, PETBREEDS TEXT, PETBIRTHDATE TEXT, PETGENDER TEXT, PETIMAGE BLOB, PETPHONE TEXT )";
                                                                                                    //add columns here
    ...
    public boolean addData(String pName,String pSpecies, String pBreeds, String pBirthDate, String pGender,  byte[] image, String pPhone) {           //add columns here
